...
function clearAll() {
  document.querySelector('.divJokes').textContent = '';
  document.querySelector('.divWisdom').textContent = '';
  document.querySelector('.divMemes').textContent = '';
  document.querySelector('.divRiddle').textContent = '';
...
function showMeme() {
  ...
  const parent = document.querySelector('.divMemes');
  const memeP = document.createElement('img');
  const src = document.createAttribute('src');
  src.value = randomMemeUrl;
  memeP.setAttributeNode(src);
  parent.appendChild(memeP);
...
function showJoke() {
  ...
  const parent = document.querySelector('.divJokes');
  const jokesText = document.createElement('p');
  jokesText.textContent = randomJokeText;
  parent.appendChild(jokesText);
}
...
function showQuote() {
  ...
  const parent = document.querySelector('.divWisdom');
  const wisdomText = document.createElement('p');
  const wisdomAuth = document.createElement('p');
  wisdomText.textContent = randomQuote.quote;
  wisdomAuth.textContent = '- ' + randomQuote.author;
  parent.appendChild(wisdomText);
  parent.appendChild(wisdomAuth);
...
function showRiddle() {
  ...
  const parent = document.querySelector('.divRiddle');
  const questionText = document.createElement('p');
  const answerText = document.createElement('p');
  questionText.textContent = randomRiddle.question;
  answerText.textContent = randomRiddle.answer;
  answerText.setAttribute('id', 'answer-show');
...
function revealAnswers() {
  const riddleContainer = document.querySelector('.divRiddle');
  const riddle = riddleContainer.querySelector('p');
  const answer = document.querySelector('#answer-show');

  if (riddle && answer.hidden) {
    answer.hidden = false;
  } else if (riddle) {
    alert('The answer has been revealed');
  } else {
